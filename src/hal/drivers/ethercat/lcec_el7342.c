...
typedef struct {
  ...
  int count_overflow_pdo_os;
  int count_overflow_pdo_bp;
  int count_underflow_pdo_os;
  int count_underflow_pdo_bp;
  ...
  int dcm_ena_pdo_os;
  int dcm_ena_pdo_bp;
  int dcm_reset_pdo_os;
  int dcm_reset_pdo_bp;
  int dcm_reduce_torque_pdo_os;
  int dcm_reduce_torque_pdo_bp;
  int dcm_velo_pdo_os;
  int dcm_ready_to_enable_pdo_os;
  int dcm_ready_to_enable_pdo_bp;
  int dcm_ready_pdo_os;
  int dcm_ready_pdo_bp;
  int dcm_warning_pdo_os;
  int dcm_warning_pdo_bp;
  int dcm_error_pdo_os;
  int dcm_error_pdo_bp;
  int dcm_move_pos_pdo_os;
  int dcm_move_pos_pdo_bp;
  int dcm_move_neg_pdo_os;
  int dcm_move_neg_pdo_bp;
  int dcm_torque_reduced_pdo_os;
  int dcm_torque_reduced_pdo_bp;
  int dcm_din1_pdo_os;
  int dcm_din1_pdo_bp;
  int dcm_din2_pdo_os;
  int dcm_din2_pdo_bp;
  int dcm_sync_err_pdo_os;
